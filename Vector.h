...
private:
    ...
    int vec_size;        // Current number of elements in the vector
    int vec_capacity;    // Current allocated storage capacity of the vector
...
public:
     ...
     * Postconditions:
     *    Item element is stored at the end of the vector.
     * Notes:
